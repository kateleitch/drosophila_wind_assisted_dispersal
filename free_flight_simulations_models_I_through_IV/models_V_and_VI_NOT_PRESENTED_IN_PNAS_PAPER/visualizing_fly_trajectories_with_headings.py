...
list_of_model_data = [ '../model_3_test_theta_12000.json']

# list_of_model_data = ['../model_1_infinite_airmin.json']
# list_of_model_data = ['../model_1.json','../model_2.json', '../model_3.json', '../model_3_12000_test_theta.json', '../model_4_flies_simply_hold.json', '../model_4_no_airspeed_flexibility.json', '../model_4_flies_kick_into_1.8ms.json']
...
for model_num, model in enumerate(list_of_model_data):
    ...
    for windspeed in d:
        ...
        for i, traj_vector in enumerate(traj_vector_list):
            ...
            if i%7 == 0:
                ax_lakebed.plot([0,traj_vector[0]],[0,traj_vector[1]], color = 'black', linewidth = 0.5)
...
ffmpeg -i ./%*.png -c:v libx264 -profile:v high -crf 20 -pix_fmt yuv420p output.mp4
