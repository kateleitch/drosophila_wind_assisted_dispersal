...
class TrapcamAnalyzer:
    def __init__(self, directory, trap='trap_A', calculate_threshold=False, calculate_final=True):  # <---- instances of this class will specify the directory, most likely using directory = sys.argv[1]
