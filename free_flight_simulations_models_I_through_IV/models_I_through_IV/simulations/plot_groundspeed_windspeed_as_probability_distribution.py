...
dict_of_model_data = {'./model_1.json':[],
                      './model_2.json':[],
                      './model_3.json':[],
...
if generate_pdfs_from_wtraj_gtraj_json == 'y':
    ...
    ###### saving data ######
    with open('./four_models_normalized_pdfs.json', mode = 'w') as f:
    ...
    ####### loading data ###########
    with open('./four_models_normalized_pdfs.json') as g:
        dict_of_model_data = json.load(g)
    # with open('./four_models_normalized_pdfs_FIELD_WINDS_flexible_airspeeds_model3_improved.json')as g:
    #     dict_of_model_data = json.load(g)
    ##############################
    ...
    model_list = ['./model_1.json',
                        './model_2.json',
                        './model_3.json',
                        './model_4_flies_simply_hold.json']

    for number, model in enumerate(model_list):
        plot_model_kde_with_conf_intervals_and_field_data(dict_of_model_data= dict_of_model_data, model_name=model, list_of_conf_int=[0.99], number = number +1, flexible_airspeeds = True)
    ...
    sideslip_pdf = np.asarray(dict_of_model_data['./model_1.json'])
    for number, model in enumerate(alternate_model_list):
        print ('alt. model: ' + model)
        alternate_pdf = np.asarray(dict_of_model_data[model])
